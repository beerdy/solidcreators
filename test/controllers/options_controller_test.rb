...
class OptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post options_url, params: { option: { slider_dots: @option.slider_dots, slider_shawod: @option.slider_shawod } }
    end
  ...
  test "should update option" do
    patch option_url(@option), params: { option: { slider_dots: @option.slider_dots, slider_shawod: @option.slider_shawod } }
