...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { description: @slider.description, link: @slider.link, show: @slider.show, slave: @slider.slave, sort: @slider.sort, title: @slider.title, url: @slider.url } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { description: @slider.description, link: @slider.link, show: @slider.show, slave: @slider.slave, sort: @slider.sort, title: @slider.title, url: @slider.url } }
